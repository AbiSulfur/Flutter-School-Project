...
class DetailPage extends StatefulWidget {
  ...
  const DetailPage({super.key, required this.playlist, required this.initialIndex});
...
class _DetailPageState extends State<DetailPage> {
  ...
  Future<void> _initAudio() async {
    try {
      final audioSources = widget.playlist.map((song) => AudioSource.uri(Uri.parse(song.audioUrl))).toList();
